...
It bundles 20 migrations in dependency order:
...
| 15 | relationship_declared | **Declared-vs-assumed flag + profile prompt** |
| 16 | tidbits_relationship | **Tidbits: author relationship + answer ranking** |
| 17 | rating_groups | **Per-organisation rating breakdown** |
| 18 | professional_verification | **One-time clinician attestation links** |
| 19 | shop_products | **Shop** (products, cart, orders, returns, reviews) |
