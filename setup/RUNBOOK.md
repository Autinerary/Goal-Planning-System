...
It bundles 12 migrations in dependency order:
...
| 12 | shop_products | **Shop** (products, cart, orders, returns, reviews) |

> Steps 09–12 `ALTER` tables created in steps 08 and in the base schema, which
